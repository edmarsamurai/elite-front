                    ...
                    <div className={styles['calendar-container']}>
                        <Calendar
                            ...
                            renderDay={(date) => {
                                ...
                                const isSameDate = metrics?.completedDates?.some(item => dayjs(item).isSame(dayjs(date)))
                                return (
                                    <Indicator size={10} color="var(--info)" offset={-2} disabled={!isSameDate}>
                                        <div>{day}</div>
                                    </Indicator>
                                );
                            }}
